...
from src.models.swinunetr import SwinUNETR3D
...
def train_swinunetr(config):
    ...
    print(f"\n{'='*20} 开始训练 SwinUNETR (基于Iteration) {'='*20}")
...
if __name__ == "__main__":
    parser = get_config_argument_parser(description="SwinUNETR 训练脚本")
    parser.add_argument("--seed", type=int, default=2025, help="随机种子 (默认: 2025)")
    args = parser.parse_args()

    default_config_path = os.path.join(project_root, "configs", "swinunetr_train.yaml")
